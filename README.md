...
cấp bản lưu từ 2.0/3.0 mà không mất thế giới.
...
| Cuốc đá          | 3 gỗ + 4 đá               | 3 nhát khai thác thu 5 đá; dùng để gỡ tinh thể |
...
| Cao dán thảo mộc | 2 nấm + 1 thảo mộc        | Dùng ngay (phím `G`): +35 máu                  |
| Đèn lồng         | 4 gỗ + 2 sợi + 1 tinh thể | Cột đèn soi sáng vùng rộng, không cần đốt lửa  |
...
- **Hồi tài nguyên qua ngày–đêm:** dùng đồng hồ mô phỏng tăng liên tục; chỉ lấy modulo khi hiển thị chu kỳ. Thời điểm hồi không bị mắc kẹt sau mỗi 24 phút.
...
src/
  ...
  art.js               Vẽ thủ tục (nấm, thảo mộc, tinh thể, địa danh) bằng Canvas
